...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addGridCounter: function() { return /* binding */ addGridCounter; },
/* harmony export */   dataFilterOnClick: function() { return /* binding */ dataFilterOnClick; },
/* harmony export */   equalHeight: function() { return /* binding */ equalHeight; },
/* harmony export */   gridItemShave: function() { return /* binding */ gridItemShave; },
/* harmony export */   hideUnusedSystemFilters: function() { return /* binding */ hideUnusedSystemFilters; },
/* harmony export */   registerColorboxHandlers: function() { return /* binding */ registerColorboxHandlers; },
/* harmony export */   registerModalScrollBlock: function() { return /* binding */ registerModalScrollBlock; }
/* harmony export */ });
...
function registerModalScrollBlock() {
  ...
  ['wheel', 'scroll'].forEach(eventType => {
    window.addEventListener(eventType, blockScrollIfModal, {
      capture: true
    });
  });
}
...
function registerColorboxHandlers() {
...
function gridItemShave() {
  $('.grid-item:not(.truncated)').each(function () {
    ...
    if ($gridItem.find('.modal-btn').length) {
      ...
      (0,shave__WEBPACK_IMPORTED_MODULE_0__["default"])($clonedDesc.find('.desc .txt'), shaveHeight, {
        character: ''
      });
      ...
      $clonedDesc.find('.desc').addClass("display-block");
      (0,shave__WEBPACK_IMPORTED_MODULE_0__["default"])($clonedDesc.find('.txt'), shaveHeight, {
        character: '[...]'
      });
...
;
function hideUnusedSystemFilters() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ shave; }
/* harmony export */ });
/**
...
function shave(target, maxHeight, opts) {
  ...
  var _a = opts.character,
    character = _a === void 0 ? '…' : _a,
    _b = opts.classname,
    classname = _b === void 0 ? 'js-shave' : _b,
    _c = opts.spaces,
    initialSpaces = _c === void 0 ? true : _c,
    _d = opts.charclassname,
    charclassname = _d === void 0 ? 'js-shave-char' : _d,
    _e = opts.link,
    link = _e === void 0 ? {} : _e;
  /**
   * @notes
  ...
  for (var i = 0; i < els.length; i += 1) {
    ...
    while (min < max) {
      ...
      el[textProp] = spaces ? wordItems.join(' ') : wordItems;
    ...
    var diff = spaces ? ' ' + diffItems.join(' ') : diffItems;
...
/* harmony import */ var _js_custom_bootstrap_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/custom-bootstrap.js */ "./src/js/custom-bootstrap.js");
/* harmony import */ var jquery_colorbox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! jquery-colorbox */ "./node_modules/jquery-colorbox/jquery.colorbox.js");
/* harmony import */ var jquery_colorbox__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(jquery_colorbox__WEBPACK_IMPORTED_MODULE_3__);
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
(0,_js_app_js__WEBPACK_IMPORTED_MODULE_1__.registerModalScrollBlock)();
...
(0,_js_app_js__WEBPACK_IMPORTED_MODULE_1__.dataFilterOnClick)();
...
$('body').on('click', '.filters-btn', function () {
  ...
  $("#target").load("/?page_id=404 #ajax-load-more", function () {
    ...
    window.almComplete = function () {
      ...
      (0,_js_app_js__WEBPACK_IMPORTED_MODULE_1__.hideUnusedSystemFilters)();
      (0,_js_app_js__WEBPACK_IMPORTED_MODULE_1__.equalHeight)();
      (0,_js_app_js__WEBPACK_IMPORTED_MODULE_1__.gridItemShave)();
      (0,_js_app_js__WEBPACK_IMPORTED_MODULE_1__.registerColorboxHandlers)();

      // Dodaj licznik na początek i koniec .grid.n2
      const $grid = $('#target.grid.n2');
      (0,_js_app_js__WEBPACK_IMPORTED_MODULE_1__.addGridCounter)($grid);
    };
